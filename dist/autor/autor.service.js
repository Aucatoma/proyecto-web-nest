...
let AutorService = class AutorService {
    ...
    findAll() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._autorRepository.find();
        });
    }
    findById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._autorRepository.findOne(id);
        });
    }
    findByNombre(nombre) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._autorRepository.find({ nombre });
        });
    }
    findByLibroId(id) {
        return __awaiter(this, void 0, void 0, function* () {
...
AutorService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_1.InjectRepository(autor_entity_1.AutorEntity)),
