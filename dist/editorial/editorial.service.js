...
let EditorialService = class EditorialService {
    ...
    findAll() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._editorialRepository.find();
        });
    }
    findByEditorialId(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._editorialRepository.findOne(id);
        });
    }
    findByEditorialName(nombre) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._editorialRepository.find({ nombre });
        });
    }
    findByLibroId(id) {
        return __awaiter(this, void 0, void 0, function* () {
...
EditorialService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_1.InjectRepository(editorial_entity_1.EditorialEntity)),
