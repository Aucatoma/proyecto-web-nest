...
let GeneroService = class GeneroService {
    constructor(_generoRepository) {
        this._generoRepository = _generoRepository;
    }
    findAll() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._generoRepository.find();
        });
    }
    findByGeneroId(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._generoRepository.findOne(id);
        });
    }
    findByGeneroName(nombre) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._generoRepository.find({ nombre: nombre });
        });
    }
    findByLibroId(id) {
        return __awaiter(this, void 0, void 0, function* () {
...
GeneroService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_1.InjectRepository(genero_entity_1.GeneroEntity)),
